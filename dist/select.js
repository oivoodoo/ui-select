 ...
 * Version: 0.19.9 - 2020-12-22T15:01:10.449Z
 * License: MIT
 */
...
angular.module("ui.select").run(["$templateCache", function($templateCache) {$templateCache.put("bootstrap/choices.tpl.html","<ul class=\"ui-select-choices ui-select-choices-content\" tabindex=\"0\"><li class=\"ui-select-choices-group\" id=\"ui-select-choices-{{ $select.generatedId }}\" role=\"listbox\"><p class=\"ui-select-visually-hidden\" role=\"alert\" aria-live=\"assertive\" aria-atomic=\"true\">Now you have {{ $select.items.length }} items to choose in the list. The selected item is <span ng-bind=\"$select.activeItemName\"></span></p><div class=\"divider\" ng-show=\"$select.isGrouped && $index > 0\"></div><div ng-show=\"$select.isGrouped\" class=\"ui-select-choices-group-label dropdown-header\" ng-bind=\"$group.name\"></div><div ng-attr-id=\"ui-select-choices-row-{{ $select.generatedId }}-{{$index}}\" class=\"ui-select-choices-row\" ng-class=\"{active: $select.isActive(this), disabled: $select.isDisabled(this)}\" role=\"option\" ng-attr-aria-selected=\"{{ $select.isActive(this) }}\"><span class=\"ui-select-choices-row-inner\"></span></div></li></ul>");
...
$templateCache.put("bootstrap/select.tpl.html","<div class=\"ui-select-container ui-select-bootstrap dropdown\" ng-class=\"{open: $select.open}\"><div class=\"ui-select-match\"></div><span ng-show=\"$select.open && $select.refreshing && $select.spinnerEnabled\" class=\"ui-select-refreshing {{$select.spinnerClass}}\"></span><div role=\"combobox\" aria-haspopup=\"listbox\" aria-live=\"polite\" aria-expanded=\"false\" aria-owns=\"ui-select-choices-{{ $select.generatedId }}\"><input type=\"search\" autocomplete=\"off\" tabindex=\"-1\" placeholder=\"{{$select.placeholder}}\" class=\"form-control ui-select-search\" aria-label=\"{{ $select.baseTitle }}\" aria-live=\"polite\" ng-class=\"{ \'ui-select-search-hidden\' : !$select.searchEnabled }\" ng-model=\"$select.search\" ng-show=\"$select.open\"></div><div ng-show=\"$select.open && $select.items.length > 0\" class=\"ui-select-dropdown dropdown-menu\"><div class=\"ui-select-header\"></div><div class=\"ui-select-choices\"></div><div class=\"ui-select-footer\"></div></div><div class=\"ui-select-no-choice\"></div></div>");
